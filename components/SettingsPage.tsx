          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">飞书绑定</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-green-50 rounded-xl">
                    {feishuBinding.feishu_avatar ? (
                      <img 
                        src={feishuBinding.feishu_avatar} 
                        alt={feishuBinding.feishu_name} 
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <span className="font-medium text-gray-900">{feishuBinding.feishu_name || '飞书用户'}</span>
                        <span className="px-1.5 py-0.5 text-[10px] font-medium bg-green-100 text-green-600 rounded">已绑定</span>
                      </div>
                      <p className="text-xs text-gray-500 mt-0.5">
                        绑定于 {feishuBinding.bound_at ? new Date(feishuBinding.bound_at).toLocaleDateString('zh-CN') : '未知'}
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <button
                      onClick={refreshFeishuBinding}
                      className="px-4 py-2 rounded-xl text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 transition-all flex items-center gap-2"
                    >
                      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M23 4v6h-6" />
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl text-sm font-medium bg-red-50 text-red-600 hover:bg-red-100 transition-all flex items-center gap-2 disabled:opacity-50"
                    >
                      {unbindingFeishu ? (
                        <>
                          <svg className="w-4 h-4 animate-spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  {feishuBindCode ? (
                    ...
                    <div className="p-4 bg-primary/5 rounded-xl border border-primary/10">
                      <div className="text-center mb-3">
                        <p className="text-xs text-gray-500 mb-2">在飞书中私聊机器人发送以下指令完成绑定：</p>
                        <div className="font-mono text-2xl font-bold text-primary tracking-widest">
                          /bind {feishuBindCode.code}
                        </div>
                      </div>
                      <div className="flex items-center justify-center gap-2 text-xs text-gray-500">
                        ...
                        <span>
                          {feishuCodeCountdown > 0 
                            ? `${Math.floor(feishuCodeCountdown / 60)}:${(feishuCodeCountdown % 60).toString().padStart(2, '0')} 后过期`
                            : '已过期'
                          }
                        </span>
                      </div>
                      <div className="flex justify-center gap-3 mt-4">
                        <button
                          onClick={handleGenerateFeishuCode}
                        ...
                        <button
                          onClick={refreshFeishuBinding}
                          className="px-4 py-2 rounded-xl text-sm font-medium bg-primary text-white hover:shadow-lg hover:shadow-primary/20 transition-all"
                        >
                          我已绑定
                        </button>
                      </div>
                    ...
                    <div className="flex items-start gap-4">
                      <div className="flex-1 space-y-2">
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          <span className="w-5 h-5 rounded-full bg-gray-100 text-xs flex items-center justify-center text-gray-500">1</span>
                          <span>在飞书中搜索并添加「Lumina 资源助手」机器人</span>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          <span className="w-5 h-5 rounded-full bg-gray-100 text-xs flex items-center justify-center text-gray-500">2</span>
                          <span>点击右侧按钮获取绑定码</span>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          <span className="w-5 h-5 rounded-full bg-gray-100 text-xs flex items-center justify-center text-gray-500">3</span>
                          <span>在飞书中发送 <code className="px-1.5 py-0.5 bg-gray-100 rounded text-xs">/bind 绑定码</code></span>
                        </div>
                      </div>
                      <button
                        onClick={handleGenerateFeishuCode}
