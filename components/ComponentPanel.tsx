...
const ANNOTATION_TOOLS = [
  {
    ...
    color: 'yellow',
    defaultConfig: { text: '', backgroundColor: '#FEF3C7', borderColor: 'transparent', fontSize: 14, width: 200, height: 100 },
  },
  {
    type: 'GROUP_BOX',
    name: '分组框',
    ...
    color: 'gray',
    defaultConfig: { title: '分组', backgroundColor: 'transparent', borderColor: '#D1D5DB', width: 300, height: 200 },
  },
  {
    type: 'ARROW',
    name: '箭头',
    description: '自由拖拽调整方向',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg>',
    color: 'blue',
    defaultConfig: { length: 120, rotation: 0, color: '#3B82F6', strokeWidth: 2, text: '' },
  },
  {
    type: 'TEXT_LABEL',
    name: '文本',
    ...
    color: 'gray',
    defaultConfig: { text: '文本', fontSize: 14, color: '#374151', backgroundColor: 'transparent', width: 100, height: 30 },
  },
  {
    type: 'ACTOR',
    name: '参与者',
    description: '小人图标',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="4" r="3"/><line x1="12" y1="7" x2="12" y2="14"/><line x1="6" y1="10" x2="18" y2="10"/><line x1="12" y1="14" x2="8" y2="20"/><line x1="12" y1="14" x2="16" y2="20"/></svg>',
    color: 'gray',
    defaultConfig: { text: '参与者', color: '#374151', scale: 1 },
  },
  {
    type: 'STATE',
    name: '状态',
    description: '状态机节点',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="6" width="18" height="12" rx="6"/></svg>',
    color: 'purple',
    defaultConfig: { text: '状态', stateType: 'normal', borderColor: '#8B5CF6', backgroundColor: '#FFFFFF', width: 100, height: 40 },
  },
  {
    type: 'IMAGE',
    name: '图片',
    ...
    color: 'green',
    defaultConfig: { src: '', width: 200, height: 150 },
  },
];
