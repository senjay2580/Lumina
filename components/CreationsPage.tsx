...
export default function CreationsPage({ userId }: Props) {
  ...
  return (
    <div className="w-full h-full overflow-y-auto">
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-8 max-md:px-4 max-md:py-5">
        <div className="mb-12 max-md:mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            />
            <div>
              <h1 className="text-3xl font-bold text-gray-900 max-md:text-2xl">我的创作</h1>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-12 gap-6 auto-rows-[180px] max-md:gap-3 max-md:auto-rows-[140px]">
            {/* 简历 - 超大卡片 (7 x 2) */}
            <motion.button
              onClick={handleResumeClick}
              className="col-span-7 row-span-2 group relative overflow-hidden bg-white border-2 border-gray-900 p-8 text-gray-900 transition-all max-md:col-span-12 max-md:row-span-2 max-md:p-4"
              whileHover={{ scale: 1.02, boxShadow: '0 8px 16px rgba(0,0,0,0.1)' }}
              whileTap={{ scale: 0.98 }}
            >
              <div className="relative z-10 h-full flex flex-col items-center justify-center text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 mb-6 max-md:w-10 max-md:h-10 max-md:mb-2" viewBox="0 0 16 16">
                ...
                <h3 className="text-4xl font-bold mb-2 max-md:text-2xl max-md:mb-1">简历</h3>
                <p className="text-gray-500 text-base mb-4 max-md:text-xs max-md:mb-2">Resume</p>
                <p className="text-gray-600 text-sm max-w-md max-md:text-xs">展示职业成长轨迹，记录能力提升</p>
              </div>
            </motion.button>
            ...
            <motion.button
              ...
              className="col-span-5 row-span-1 group relative overflow-hidden bg-white border-2 border-gray-900 p-6 text-gray-900 transition-all max-md:col-span-12 max-md:p-4"
              whileHover={{ scale: 1.02, boxShadow: '0 8px 16px rgba(0,0,0,0.1)' }}
              whileTap={{ scale: 0.98 }}
            >
            ...
            <motion.button
              ...
              className="col-span-4 row-span-1 group relative overflow-hidden bg-white border-2 border-gray-900 p-6 text-gray-900 transition-all max-md:col-span-12 max-md:p-4"
              whileHover={{ scale: 1.02, boxShadow: '0 8px 16px rgba(0,0,0,0.1)' }}
              whileTap={{ scale: 0.98 }}
            >
              <div className="relative z-10 h-full flex items-center justify-between">
            ...
            <motion.button
              ...
              className="col-span-3 row-span-1 group relative overflow-hidden bg-white border-2 border-gray-900 p-6 text-gray-900 transition-all max-md:col-span-12 max-md:p-4"
              whileHover={{ scale: 1.02, boxShadow: '0 8px 16px rgba(0,0,0,0.1)' }}
              whileTap={{ scale: 0.98 }}
            >
              <div className="relative z-10 h-full flex flex-col items-center justify-center text-center">
